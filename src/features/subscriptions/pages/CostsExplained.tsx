...
const [freePlan, basicPlan, plusPlan, proPlan] = plans;
...
const CostsExplained: React.FC = () => (
  <div style={{ padding: 16, lineHeight: 1.6 }}>
    ...
    <ul>
      <li><strong>Plano {freePlan.title}</strong>: custeado pelos assinantes, com limites para manter o uso viável.</li>
      <li><strong>Plano {basicPlan.title}</strong>: cobre custos iniciais de IA e libera mais registros.</li>
      <li><strong>Plano {plusPlan.title}</strong>: cobre parte dos custos de IA, libera mais registros e relatórios avançados.</li>
      <li><strong>Plano {proPlan.title}</strong>: financia integrações extras, maior limite de registros e acesso prioritário a novos recursos.</li>
    </ul>
